...
export default function Home() {
  ...
  return (
    ...
    <img src='./assets/images/Logowhite.png' alt="Logo" className="w-15 h-20 fixed top-0 left-0 m-4" />
    <h1 className="text-white ml-12">Gig<b>nite</b></h1>
  </div>

      {/* <img className="w-[3%] mr-30" src='./assets/images/Logowhite.png'></img>
       
      <div className="text-white mr-[75%]">Gig<p className="inline font-bold text-[#13C3B5]">nite</p></div> */}
