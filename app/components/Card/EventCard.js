...
const EventCard = (props) => {
  ...
  <>
      ...
      <div
        ...
        // }
      >
        <img className="object-cover w-full h-full rounded-xl" src={props.photo} alt="EventPhoto" />

        <div className="bg-black/50 absolute top-0 text-white w-full h-full text-center flex flex-col justify-center border-4 border-black hover:border-4 hover:border-[#1AA297] hover:cursor-pointer rounded-xl" onClick={
          () => {
            handleClickOpen(props)
          }
        }>
          ...
          <div className="absolute bottom-0 -left-7 col-span-1 md:col-span-2 flex gap-10 mx-20 justify-center space-x-4 mt-5">
            <button
              type="submit"
