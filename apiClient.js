...
async nonAuthenticatedCall(method, url, data) {
  ...
  addEvent(name, city, date, price, time, photo) {
    console.log("addEvent Api Client called")
    return this.authenticatedCall("post", url, { name, city, date, price, time, photo });
  }
  ...
  updateEvent(id, name, city, date, price, time, photo) {
    console.log(`Calling Update: ${id}`)
    return this.authenticatedCall("put", `${url}${id}`, { name, city, date, price, time, photo });
  }
